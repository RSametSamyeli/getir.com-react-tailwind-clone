...
const Header = () => {
  return (
    <div className="bg-brand-color">
      <div className="container h-11 mx-auto flex items-center justify-center md:justify-between md:px-4 ">
        <div className="logo">
          <a href="#">
            <img
        ...
        <nav className="hidden  md:flex  text-sm font-semibold  gap-x-4 ">
          <a
            href="#"
            className="  flex items-center gap-x-2 text-white  text-opacity-75 hover:text-opacity-90  transition-all "
          >
            <FiGlobe size={20} />
            Turkçe (TR)
          </a>
